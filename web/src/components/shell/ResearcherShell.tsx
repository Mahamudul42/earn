...
const NAV = [
  { href: "/researcher", label: "Overview", icon: BarChart3 },
  { href: "/researcher/rate", label: "Rate responses", icon: ClipboardList },
  { href: "/researcher/prompt-lab", label: "Prompt lab", icon: FlaskConical },
];
...
export function ResearcherShell({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // Authentication is stored in localStorage and can only be resolved after
    // the client hydrates.
